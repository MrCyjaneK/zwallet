...
class WarpApi {
  ...
  static DynamicLibrary open() {
    ...
    if (Platform.isIOS) return DynamicLibrary.open('WarpApiFFI.framework/WarpApiFFI');
    ...
    if (Platform.isMacOS) return DynamicLibrary.open('WarpApiFFI.framework/WarpApiFFI');
